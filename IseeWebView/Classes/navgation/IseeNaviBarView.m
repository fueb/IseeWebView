...
@implementation IseeNaviBarView {
    __weak IseeWebViewController *_controller;
    UIView *_statusBar;
...
- (instancetype)initWithController:(IseeWebViewController *)controller {
   ...
   if (@available(iOS 13.0, *)) {
    ...
    self = [super initWithFrame:CGRectMake(0, 0, ScreenWidth, statusBarH)];
...
- (void)setNavigationBarClolor:(UIColor *)color {
